<template>
  ...
  <q-input color="teal" outlined v-model="theModel.stoppageTime" label="StoppageTime" clearable :rules="timeRule" />
  <q-input color="teal" outlined v-model="theModel.stoppageTimeAnnounced" label="StoppageTimeAnnounced" clearable :rules="timeRule" />
